...
protorequirements = """<requirements>
      ...
      <container type="docker">toolfactory/custombuild</container>
</requirements>"""
...
def build_docker(dockerfile, docker_client, tag='base'):
    '''Given the path to a dockerfile, and a docker_client, build the image, if it does not
    exist yet.'''
    image_id='toolfactory/custombuild:'+tag
...
class ScriptRunner:
    ...
    def __init__(self,opts=None,treatbashSpecial=True):
        ...
        os.chdir(os.path.abspath(opts.output_dir))
